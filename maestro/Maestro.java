...
/**
 * Maestro - a robot by 0821260006
 */
public class Maestro extends AdvancedRobot {
	...
	public void onScannedRobot(ScannedRobotEvent e) {
		...
		// giro para realizar movimento espiral/meia lua ao inimigo
		setTurnRight(normalRelativeAngleDegrees(e.getBearing() + 30));
